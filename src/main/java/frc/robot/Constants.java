...
//import com.revrobotics.CANSparkLowLevel.MotorType; //Probably responsible for an error - class "CANSparkLowLevel" is now deprecated
...
public final class Constants {
  ...
  /*
  private final CANSparkMax m_leftMotor = new CANSparkMax(4, MotorType.kBrushed);
